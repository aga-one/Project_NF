...
schedule="0 0 * * *"
    ...
    split_data_f101 = DummyOperator(
        task_id="split_data_f101"
    )

    call_dm_fill_f101_round_f = SQLExecuteQueryOperator(
        task_id="call_dm_fill_f101_round_f",
        conn_id="postgres-db",
        sql=r"CALL dm.fill_f101_round_f('2018-02-01'::date, '{{run_id}}')"
    )
